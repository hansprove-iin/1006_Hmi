...
(function (/** @type {globalThis.TcHmi} */ TcHmi) {
    ...
    (function (/** @type {globalThis.TcHmi.Functions} */ Functions) {
        ...
        (function (TcHmiProject1) {
            function ToggleVisibility(par1) {
            ...
            if (currentValue === 'Visible') {
                TcHmi.Symbol.writeEx(par1, 'Collapsed');
            } else
                TcHmi.Symbol.writeEx(par1, 'Visible');
            }

            
            TcHmiProject1.ToggleVisibility = ToggleVisibility;
        })(TcHmiProject1 = Functions.TcHmiProject1 || (Functions.TcHmiProject1 = {}));
    })(Functions = TcHmi.Functions || (TcHmi.Functions = {}));
})(TcHmi);
TcHmi.Functions.registerFunctionEx('ToggleVisibility', 'TcHmi.Functions.TcHmiProject1', TcHmi.Functions.TcHmiProject1.ToggleVisibility);
